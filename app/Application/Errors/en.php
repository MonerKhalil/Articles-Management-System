...
return [
    ...
    "comment.required" => "The comment input is required",
    "comment.string" => "The id comment input is not string",
    ...
    "fav.suc" => "The article has been successfully added to your favourites",
    "fav.del" => "This article has been removed from your favourites",
